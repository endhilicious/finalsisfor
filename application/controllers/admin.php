...
class Admin extends CI_Controller {
	...
	public function save(){
		$data = array('nama' => $this->input->post('nama'), 'email' => $this->input->post('email'), 'notelp' => $this->input->post('notelp'), 'instagram' => $this->input->post('instagram'), 'tanggallahir' => $this->input->post('tanggallahir'), 'pekerjaan' => $this->input->post('pekerjaan'),'universitas' => $this->input->post('universitas'));
