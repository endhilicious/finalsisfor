                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?php echo base_url('index.php/admin/update'); ?>" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="telp" id="email_address" class="form-control" placeholder="masukkan nomor telepon" value="<?php echo $detail->notelp; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="instansi" id="email_address" class="form-control" placeholder="masukkan instansi / universitas" value="<?php echo $detail->universitas; ?>">
                                    </div>
                                </div>
                                <br>
