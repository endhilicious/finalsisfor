                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?php echo base_url('index.php/admin/save'); ?>" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="notelp" id="email_address" class="form-control" placeholder="masukkan nomor telepon">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="universitas" id="email_address" class="form-control" placeholder="masukkan instansi / universitas">
                                    </div>
                                </div>
                                <br>
